 ...
 *
 * Written by Matt Riedel (http://github.com/mriedel90/MazdaApps)
...
CustomApplicationsHandler.register("app.speedometer", new CustomApplication({
	...
	created: function() {
		...
		this.speedoAltitude =  $("<div/>").attr("id", "speedoaltitude").appendTo(this.canvas);
	...
	setGPSHeading: function(heading) {
		heading += 150;  //offset for some reason
		// 0 = North, 180 = South
		this.gpsPanel.css({
	...
	setAltitude: function(altitude) {
		...
		this.speedoAltitude.html("Altitude: " + altitude + " ft");
	},
